...
public class Ex01_String {
	public static void main(String[] args) {
		// String : 기본형 변수x, 참조형 변수 타입
		// 참조형 변수는 스택이라는 메모리 공간에 힙 영역의 주소만 저장하고 실제값은
		...
		String strVar3 = new String("KYG");
		String strVar4 = new String("KYG");
		
		Scanner sc = new Scanner(System.in);
		String strVar5 = sc.nextLine();   // 이니셜을 대문자로 입력하기
		if(strVar1 == strVar5) {
			System.out.println("strVal 1 == strVar5");
