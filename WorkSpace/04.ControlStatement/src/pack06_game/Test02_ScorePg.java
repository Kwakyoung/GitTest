...
public class Test02_ScorePg {
	public static void main(String[] args) {
		...
		int kor = -1 , eng = -1 , mat = -1 ; // -1 이면 입력x 상태
		System.out.println("국어 점수를 입력해주세요.");
		while(kor == -1) {  // 초기에 -1로 값을 초기화 해놨기 때문에 초기화만 된상태에서는 계속해서 반복
		...
		while(eng == -1) {  // 초기에 -1로 값을 초기화 해놨기 때문에 초기화만 된상태에서는 계속해서 반복
		...
		while(mat == -1) {  // 초기에 -1로 값을 초기화 해놨기 때문에 초기화만 된상태에서는 계속해서 반복
